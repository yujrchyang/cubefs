...
export default {
  ...
  methods: {
    ...
    queryList(key) {
      ...
      this.apollo
        .query(this.url.consoleTraffic, baseGql.listTopVol, params)
        .then(res => {
          if (res.data && res.data.listTopVol) {
            this.list = res.data.listTopVol.data || [];
            this.page.totalRecord = res.data.listTopVol.total;
          } else {
