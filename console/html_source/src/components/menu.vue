<template>
  <div class="left-menu">
    <el-menu
      class="el-menu-vertical-demo menu-wrapper"
    ...
    >
      ...
      <el-submenu index="/cluster">
        <template slot="title">
          <i class="el-icon-film" style="display: initial;"></i>
          <span>{{ $t("chubaoFS.nav.Cluster") }}</span>
        </template>
        <el-menu-item index="/cluster/overview">{{
          $t("chubaoFS.nav.ClusterOverview")
        }}</el-menu-item>
        <el-menu-item index="/cluster/detail">{{
          $t("chubaoFS.nav.ClusterDetail")
        }}</el-menu-item>
        <el-menu-item index="/cluster/serverList">{{
          $t("chubaoFS.nav.ClusterTopo")
        }}</el-menu-item>
        <el-menu-item index="/cluster/health">{{
          $t("chubaoFS.nav.ClusterHealth")
        }}</el-menu-item>
      </el-submenu>
      <el-menu-item index="/monitor">
        ...
        ></i>
        <span slot="title" style="padding-left:27px;">{{
          $t("chubaoFS.nav.Monitor")
        }}</span>
      </el-menu-item>
      <!-- <el-submenu index="/monitor">
        <template slot="title">
          <i class="el-icon-data-line" style="display: initial;"></i>
          <span>{{ $t("chubaoFS.nav.Monitor") }}</span>
        </template>
        <el-menu-item index="/cluster/overview">{{
          $t("chubaoFS.nav.ClusterOverview")
        }}</el-menu-item>
      ...
      <div class="menu-link">
        <a
          class="github"
          href="https://github.com/cubefs/cubefs"
          target="_blank"
        ></a>
        <a
          class="twitter"
          href="https://twitter.com/chubaofs"
          target="_blank"
        ></a>
...
.menu-wrapper.el-menu--collapse > .el-menu-item:focus,
.menu-wrapper.el-menu--collapse > .el-menu-item:hover,
.menu-wrapper.el-menu--collapse > .el-menu-item.is-active {
  margin-bottom: 10px;
  background-color: #fff;
  border-radius: 15px;
  color: #07268d;
}
.menu-wrapper.el-menu--collapse > .el-menu-item i,
.menu-wrapper.el-menu--collapse .el-submenu__title i {
  padding-right: 0;
  font-size: 24px;
}
...
.menu-wrapper.el-menu--collapse .el-menu-item:hover i.menuIcon1,
.menu-wrapper.el-menu--collapse .el-menu-item.is-active i.menuIcon1 {
  background: url("../assets/images/menuActive1.png") no-repeat left center;
  background-size: 23px auto;
}
.menu-wrapper.el-menu--collapse .el-menu-item:hover i.menuIcon2,
.menu-wrapper.el-menu--collapse .el-menu-item.is-active i.menuIcon2 {
  background: url("../assets/images/menuActive2.png") no-repeat left center;
  background-size: 23px auto;
}
.menu-wrapper.el-menu--collapse .el-menu-item:hover i.menuIcon3,
.menu-wrapper.el-menu--collapse .el-menu-item.is-active i.menuIcon3 {
  background: url("../assets/images/menuActive3.png") no-repeat left center;
  background-size: 23px auto;
}
.menu-wrapper.el-menu--collapse .el-menu-item:hover i.menuIcon4,
.menu-wrapper.el-menu--collapse .el-menu-item.is-active i.menuIcon4 {
  background: url("../assets/images/menuActive4.png") no-repeat left center;
  background-size: 23px auto;
}
.menu-wrapper.el-menu--collapse .el-menu-item:hover i.menuIcon5,
.menu-wrapper.el-menu--collapse .el-menu-item.is-active i.menuIcon5 {
  background: url("../assets/images/menuActive5.png") no-repeat left center;
  background-size: 23px auto;
}
.menu-wrapper.el-menu--collapse .el-menu-item:hover i.menuIcon6,
.menu-wrapper.el-menu--collapse .el-menu-item.is-active i.menuIcon6 {
  background: url("../assets/images/menuActive6.png") no-repeat left center;
  background-size: 23px auto;
}
.menu-wrapper.el-menu--collapse .el-menu-item:hover i.menuIcon7,
.menu-wrapper.el-menu--collapse .el-menu-item.is-active i.menuIcon7 {
  background: url("../assets/images/menuActive7.png") no-repeat left center;
  background-size: 23px auto;
}
</style>
