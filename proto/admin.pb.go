...
type MetaPartitionViewPb struct {
	...
	Recorders            []string `protobuf:"bytes,16,rep,name=Recorders,proto3" json:"Recorders,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *MetaPartitionViewPb) GetRecorders() []string {
	if m != nil {
		return m.Recorders
	}
	return nil
...
type BoundBucketInfo struct {
	EndPoint        string `protobuf:"bytes,1,opt,name=EndPoint,proto3" json:"end_point"`
	BucketName      string `protobuf:"bytes,2,opt,name=BucketName,proto3" json:"bucket_name"`
	Region          string `protobuf:"bytes,3,opt,name=Region,proto3" json:"region"`
	AccessKey       string `protobuf:"bytes,4,opt,name=AccessKey,proto3" json:"ak"`
	SecretAccessKey string `protobuf:"bytes,5,opt,name=SecretAccessKey,proto3" json:"sk"`
}

func (m *BoundBucketInfo) Reset()         { *m = BoundBucketInfo{} }
func (m *BoundBucketInfo) String() string { return proto.CompactTextString(m) }
func (*BoundBucketInfo) ProtoMessage()    {}
func (*BoundBucketInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_73a7fc70dcc2027c, []int{14}
}
func (m *BoundBucketInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BoundBucketInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BoundBucketInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BoundBucketInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BoundBucketInfo.Merge(m, src)
}
func (m *BoundBucketInfo) XXX_Size() int {
	return m.Size()
}
func (m *BoundBucketInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_BoundBucketInfo.DiscardUnknown(m)
}

var xxx_messageInfo_BoundBucketInfo proto.InternalMessageInfo

func (m *BoundBucketInfo) GetEndPoint() string {
	if m != nil {
		return m.EndPoint
	}
	return ""
...
func (m *BoundBucketInfo) GetBucketName() string {
	if m != nil {
		return m.BucketName
	}
	return ""
...
func (m *BoundBucketInfo) GetRegion() string {
	if m != nil {
		return m.Region
	}
	return ""
...
func (m *BoundBucketInfo) GetAccessKey() string {
	if m != nil {
		return m.AccessKey
	}
	return ""
...
func (m *BoundBucketInfo) GetSecretAccessKey() string {
	if m != nil {
...
type SimpleVolViewPb struct {
	...
	RDMA                   bool                      `protobuf:"varint,103,opt,name=RDMA,proto3" json:"RDMA,omitempty"`
	DpRecorderNum          uint32                    `protobuf:"varint,104,opt,name=DpRecorderNum,proto3" json:"DpRecorderNum,omitempty"`
	MpRecorderNum          uint32                    `protobuf:"varint,105,opt,name=MpRecorderNum,proto3" json:"MpRecorderNum,omitempty"`
	MetaOut                bool                      `protobuf:"varint,106,opt,name=MetaOut,proto3" json:"MetaOut,omitempty"`
	ReqRecordsReservedTime int32                     `protobuf:"varint,107,opt,name=ReqRecordsReservedTime,proto3" json:"ReqRecordsReservedTime,omitempty"`
	ReqRecordsMaxCount     int32                     `protobuf:"varint,108,opt,name=ReqRecordsMaxCount,proto3" json:"ReqRecordsMaxCount,omitempty"`
	MpZones                string                    `protobuf:"bytes,109,opt,name=MpZones,proto3" json:"MpZones,omitempty"`
	MpFollowerRead         bool                      `protobuf:"varint,110,opt,name=MpFollowerRead,proto3" json:"MpFollowerRead,omitempty"`
	PersistenceMode        int32                     `protobuf:"varint,111,opt,name=PersistenceMode,proto3" json:"PersistenceMode,omitempty"`
	BoundBucket            *BoundBucketInfo          `protobuf:"bytes,112,opt,name=BoundBucket,proto3" json:"BoundBucket,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                  `json:"-"`
	XXX_unrecognized       []byte                    `json:"-"`
	XXX_sizecache          int32                     `json:"-"`
}
...
func (m *SimpleVolViewPb) GetRDMA() bool {
	if m != nil {
		return m.RDMA
	}
	return false
...
func (m *SimpleVolViewPb) GetDpRecorderNum() uint32 {
	if m != nil {
		return m.DpRecorderNum
	}
	return 0
}

func (m *SimpleVolViewPb) GetMpRecorderNum() uint32 {
	if m != nil {
		return m.MpRecorderNum
	}
	return 0
}

func (m *SimpleVolViewPb) GetMetaOut() bool {
	if m != nil {
		return m.MetaOut
	}
	return false
...
func (m *SimpleVolViewPb) GetReqRecordsReservedTime() int32 {
	if m != nil {
		return m.ReqRecordsReservedTime
	}
	return 0
}

func (m *SimpleVolViewPb) GetReqRecordsMaxCount() int32 {
	if m != nil {
		return m.ReqRecordsMaxCount
	}
	return 0
}

func (m *SimpleVolViewPb) GetMpZones() string {
	if m != nil {
		return m.MpZones
	}
	return ""
...
func (m *SimpleVolViewPb) GetMpFollowerRead() bool {
	if m != nil {
		return m.MpFollowerRead
	}
	return false
}

func (m *SimpleVolViewPb) GetPersistenceMode() int32 {
	if m != nil {
		return m.PersistenceMode
	}
	return 0
}

func (m *SimpleVolViewPb) GetBoundBucket() *BoundBucketInfo {
	if m != nil {
		return m.BoundBucket
	}
	return nil
}
...
func (m *NodeView) GetZone() string {
	if m != nil {
		return m.Zone
	}
	return ""
...
type ClusterViewPb struct {
	...
	RDMA                                bool                   `protobuf:"varint,58,opt,name=RDMA,proto3" json:"RDMA,omitempty"`
	RDMASend                            bool                   `protobuf:"varint,59,opt,name=RDMASend,proto3" json:"RDMASend,omitempty"`
	RDMAReConnDelayTime                 int64                  `protobuf:"varint,60,opt,name=RDMAReConnDelayTime,proto3" json:"RDMAReConnDelayTime,omitempty"`
	XXX_NoUnkeyedLiteral                struct{}               `json:"-"`
	XXX_unrecognized                    []byte                 `json:"-"`
	XXX_sizecache                       int32                  `json:"-"`
}
...
func (m *ClusterViewPb) GetRDMA() bool {
	if m != nil {
		return m.RDMA
	}
	return false
...
func (m *ClusterViewPb) GetRDMASend() bool {
	if m != nil {
		return m.RDMASend
	}
	return false
...
func (m *ClusterViewPb) GetRDMAReConnDelayTime() int64 {
	if m != nil {
		return m.RDMAReConnDelayTime
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*BoundBucketInfo)(nil), "proto.BoundBucketInfo")
...
var fileDescriptor_73a7fc70dcc2027c = []byte{
	...
	,
}
...
func (m *MetaPartitionViewPb) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Recorders) > 0 {
		for iNdEx := len(m.Recorders) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Recorders[iNdEx])
			copy(dAtA[i:], m.Recorders[iNdEx])
			i = encodeVarintAdmin(dAtA, i, uint64(len(m.Recorders[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x82
...
func (m *BoundBucketInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BoundBucketInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BoundBucketInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.SecretAccessKey) > 0 {
		...
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.SecretAccessKey)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.AccessKey) > 0 {
	...
	if len(m.Region) > 0 {
		...
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.Region)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.BucketName) > 0 {
		...
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.BucketName)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.EndPoint) > 0 {
...
func (m *SimpleVolViewPb) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BoundBucket != nil {
		{
			size, err := m.BoundBucket.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.PersistenceMode != 0 {
		i = encodeVarintAdmin(dAtA, i, uint64(m.PersistenceMode))
		i--
		dAtA[i] = 0x6
		i--
		dAtA[i] = 0xf8
	...
	if len(m.MpZones) > 0 {
		i -= len(m.MpZones)
		copy(dAtA[i:], m.MpZones)
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.MpZones)))
		i--
		dAtA[i] = 0x6
		i--
		dAtA[i] = 0xea
	}
	if m.ReqRecordsMaxCount != 0 {
		i = encodeVarintAdmin(dAtA, i, uint64(m.ReqRecordsMaxCount))
		i--
		dAtA[i] = 0x6
		i--
		dAtA[i] = 0xe0
	}
	if m.ReqRecordsReservedTime != 0 {
		i = encodeVarintAdmin(dAtA, i, uint64(m.ReqRecordsReservedTime))
		i--
		dAtA[i] = 0x6
		i--
		dAtA[i] = 0xd8
	...
	if m.MpRecorderNum != 0 {
		i = encodeVarintAdmin(dAtA, i, uint64(m.MpRecorderNum))
		i--
		dAtA[i] = 0x6
		i--
		dAtA[i] = 0xc8
	}
	if m.DpRecorderNum != 0 {
		i = encodeVarintAdmin(dAtA, i, uint64(m.DpRecorderNum))
		i--
		dAtA[i] = 0x6
		i--
		dAtA[i] = 0xc0
...
func (m *NodeView) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Zone) > 0 {
		i -= len(m.Zone)
		copy(dAtA[i:], m.Zone)
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.Zone)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Version) > 0 {
...
func (m *ClusterViewPb) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RDMAReConnDelayTime != 0 {
		i = encodeVarintAdmin(dAtA, i, uint64(m.RDMAReConnDelayTime))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xe0
...
func (m *BoundBucketInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SimpleVolViewPb) Size() (n int) {
	...
	if m.DpRecorderNum != 0 {
		n += 2 + sovAdmin(uint64(m.DpRecorderNum))
	}
	if m.MpRecorderNum != 0 {
		n += 2 + sovAdmin(uint64(m.MpRecorderNum))
	}
	if m.MetaOut {
		n += 3
	}
	if m.ReqRecordsReservedTime != 0 {
		n += 2 + sovAdmin(uint64(m.ReqRecordsReservedTime))
	}
	if m.ReqRecordsMaxCount != 0 {
		n += 2 + sovAdmin(uint64(m.ReqRecordsMaxCount))
	}
	l = len(m.MpZones)
	if l > 0 {
		n += 2 + l + sovAdmin(uint64(l))
	...
	if m.PersistenceMode != 0 {
		n += 2 + sovAdmin(uint64(m.PersistenceMode))
	}
	if m.BoundBucket != nil {
		l = m.BoundBucket.Size()
		n += 2 + l + sovAdmin(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *ClusterViewPb) Size() (n int) {
	...
	if m.RDMAReConnDelayTime != 0 {
		n += 2 + sovAdmin(uint64(m.RDMAReConnDelayTime))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *MetaPartitionViewPb) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Recorders", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Recorders = append(m.Recorders, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAdmin(dAtA[iNdEx:])
...
func (m *BoundBucketInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BoundBucketInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BoundBucketInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SimpleVolViewPb) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 104:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DpRecorderNum", wireType)
			}
			m.DpRecorderNum = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DpRecorderNum |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 105:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MpRecorderNum", wireType)
			}
			m.MpRecorderNum = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MpRecorderNum |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 106:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MetaOut", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 107:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReqRecordsReservedTime", wireType)
			}
			m.ReqRecordsReservedTime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAdmin
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReqRecordsReservedTime |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 108:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReqRecordsMaxCount", wireType)
			}
			m.ReqRecordsMaxCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAdmin
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReqRecordsMaxCount |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 109:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MpZones", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MpZones = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 110:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MpFollowerRead", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MpFollowerRead = bool(v != 0)
		case 111:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PersistenceMode", wireType)
			}
			m.PersistenceMode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PersistenceMode |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 112:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BoundBucket", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BoundBucket == nil {
				m.BoundBucket = &BoundBucketInfo{}
			}
			if err := m.BoundBucket.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ClusterViewPb) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 59:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RDMASend", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 60:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RDMAReConnDelayTime", wireType)
			}
			m.RDMAReConnDelayTime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAdmin
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RDMAReConnDelayTime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
