...
func (c *client) initUmpKeys(isMysql bool) {
	...
	c.umpKeyVolArr = append(c.umpKeyVolArr, fmt.Sprintf("%vread", volKeyPrefix))
	...
	c.umpKeyVolArr = append(c.umpKeyVolArr, fmt.Sprintf("%vwrite", volKeyPrefix))
	...
	c.umpKeyClusterArr = append(c.umpKeyClusterArr, fmt.Sprintf("%vread", clusterKeyPrefix))
	...
	c.umpKeyClusterArr = append(c.umpKeyClusterArr, fmt.Sprintf("%vwrite", clusterKeyPrefix))
