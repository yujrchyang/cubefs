...
var (
	...
	readConnTimeout = ReadTimeoutData * int64(time.Second)
)
...
func TestNearRead(t *testing.T) {
	...
	if err := mc.AdminAPI().UpdateVolume(ltptestVolume, 30, 3, 3, 30, 1,
		...
		"", false, false, 0, false, 0, readConnTimeout, readConnTimeout, 0, 0, false, false, false, 0, 0, proto.PersistenceMode_Nil); err != nil {
