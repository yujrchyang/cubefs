...
func TestUserAPI(t *testing.T) {
	...
	err = testMc.AdminAPI().CreateVolume(testTransVol, testOwner, testMpcount, testDpSize, testCapacity, testReplicas, testMpReplicas,
		testTrashDays, testStoreMode, testFollowerRead, testAutoRepair, testVolWriteMutex, testForceROW, false, testEnableWriteCache,
		testZoneName, testMpLyout, "", 0, proto.CompactDefaultName, 4, 2, false,
		0, 0, 0, false, false)
	if err != nil {
