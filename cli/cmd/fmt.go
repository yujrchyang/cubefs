...
func formatSimpleVolView(svv *proto.SimpleVolView) string {
	...
	sb.WriteString(fmt.Sprintf("  NotCacheNode         : %v\n", formatEnabledDisabled(svv.NotCacheNode)))
	sb.WriteString(fmt.Sprintf("  Flock                : %v\n", formatEnabledDisabled(svv.Flock)))
	...
	sb.WriteString(fmt.Sprintf("  Meta recorder num    : %v\n", svv.MpRecorderNum))
	...
	if svv.ConnConfig != nil {
		sb.WriteString(fmt.Sprintf("  IdleTimeout           : %v s\n", svv.ConnConfig.IdleTimeoutSec))
		sb.WriteString(fmt.Sprintf("  ConnTimeout           : %v ms\n", svv.ConnConfig.ConnectTimeoutNs/int64(time.Millisecond)))
	...
	sb.WriteString(fmt.Sprintf("  PersistenceMode         : %v (%v)\n", svv.PersistenceMode.String(), svv.PersistenceMode.Int32()))
	return sb.String()
}
